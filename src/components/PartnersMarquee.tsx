    ...
    <section className="relative py-20 overflow-hidden" dir={dir}>
      <div className="px-6 max-w-7xl mx-auto text-center mb-10">
        ...
        <h2 className="font-black leading-[1.4] py-2">
          <span className="text-gradient text-2xl sm:text-6xl font-mono font-extrabold text-center text-slate-50 bg-slate-800 px-4 py-2 inline-block leading-[1.4] whitespace-nowrap">شركاؤنا</span>
        </h2>
