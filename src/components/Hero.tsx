      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto flex flex-col items-center text-center py-6">
        <div className="relative w-full max-w-full flex items-center justify-center isolate overflow-hidden">
          <motion.span
            ...
            className="absolute z-30 right-[2%] sm:right-[4%] lg:right-[6%] top-[55%] -translate-y-1/2 text-3xl sm:text-5xl lg:text-7xl font-extrabold tracking-widest bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent drop-shadow-[0_0_20px_hsl(var(--primary)/0.5)] pointer-events-none select-none"
          >
            وكـــــــــالـــــة
          </motion.span>
          <motion.span
            ...
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 1, delay: 0.3 }}
            className="absolute z-30 left-[2%] sm:left-[4%] lg:left-[6%] top-[55%] -translate-y-1/2 text-3xl sm:text-5xl lg:text-7xl font-extrabold tracking-widest bg-gradient-to-r from-accent to-primary bg-clip-text text-transparent drop-shadow-[0_0_20px_hsl(var(--primary)/0.5)] pointer-events-none select-none"
          >
