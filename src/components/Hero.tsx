        ...
        <LampContainer className="min-h-[600px] sm:min-h-[680px] lg:min-h-[760px] bg-transparent">
          <div dir="rtl" className="relative w-full max-w-[900px] flex items-center justify-center isolate">
            <motion.span
              ...
              lang="ar"
              dir="rtl"
              className="absolute z-30 right-[-2%] sm:right-[3%] lg:right-[4%] top-1/2 -translate-y-1/2 font-black leading-none whitespace-nowrap text-white sm:text-primary pointer-events-none select-none tracking-[0.04em] sm:tracking-[0.08em]"
            ...
            <motion.span
              ...
              lang="ar"
              dir="rtl"
              className="absolute z-30 left-[-2%] sm:left-[3%] lg:left-[4%] top-1/2 -translate-y-1/2 font-black leading-none whitespace-nowrap text-white sm:text-primary pointer-events-none select-none tracking-[0.04em] sm:tracking-[0.08em]"
              style={{ fontFamily: '"Roboto Condensed", sans-serif', fontSize: "clamp(1.1rem, 5.2vw, 4.4rem)", fontWeight: 800, textShadow: "0 0 10px hsl(var(--primary) / 0.7), 0 0 28px hsl(var(--primary) / 0.45), 0 0 60px hsl(var(--primary) / 0.25)" }}
            >
              إتـــــقـــــان
            </motion.span>
            <motion.div
              ...
              transition={{ duration: 0.9, delay: 0.5, ease: "easeInOut" }}
              whileHover={{ y: -4, scale: 1.035, filter: "brightness(1.08) drop-shadow(0 0 28px hsl(var(--primary) / 0.75))" }}
              whileTap={{ scale: 0.99 }}
