      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto flex flex-col items-center text-center py-6">
        <div dir="rtl" className="relative w-full max-w-full flex items-center justify-center isolate">
          <motion.span
            ...
            lang="ar"
            dir="rtl"
            className="absolute z-30 right-[3%] sm:right-[6%] lg:right-[8%] top-1/2 -translate-y-1/2 font-arabic font-extrabold leading-none whitespace-nowrap text-[#28bdb3] pointer-events-none select-none"
            style={{ fontSize: "clamp(1.5rem, 4vw, 3.6rem)", textShadow: "0 0 6px rgba(40,189,179,0.5), 0 0 18px rgba(40,189,179,0.25)" }}
          >
            وكـــــالـــــة
          </motion.span>
          <motion.span
            ...
            lang="ar"
            dir="rtl"
            className="absolute z-30 left-[3%] sm:left-[6%] lg:left-[8%] top-1/2 -translate-y-1/2 font-arabic font-extrabold leading-none whitespace-nowrap text-[#5fd9cf] pointer-events-none select-none"
